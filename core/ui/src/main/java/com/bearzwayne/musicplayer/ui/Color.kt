...
val darkerBestOrange = Color(0xFFE69500)
val seriousBlack = Color(0xFF111111)
val seriousWhite = Color(0xFFF5F5F5)
val bestOrange = Color(0xFFFFA500)
val brighterBestOrange = Color(0xFFFFE500)
