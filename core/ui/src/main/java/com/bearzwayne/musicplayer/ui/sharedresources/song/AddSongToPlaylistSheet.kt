...
fun AddSongToPlaylistSheet(
    ...
    val allTracksName = stringResource(R.string.all_tracks)
    val recentlyAddedName = stringResource(R.string.recently_added)

    val toastErrorContent = stringResource(id = R.string.track_already_added_to_that_playlist)
    val trackAddedTemplate = stringResource(R.string.track_added_to_playlist)
    ModalBottomSheet(
                ...
                if (
                    ...
                    LibraryHorizontalCardItem(item) {
                        ...
                        if (!item.songList.contains(songSettingsItem)){
                            ...
                            val message = String.format(trackAddedTemplate, playlistName)
