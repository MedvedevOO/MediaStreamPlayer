...
import com.bearzwayne.musicplayer.ui.HomeEvent
import com.bearzwayne.musicplayer.ui.HomeUiState
...
fun BoxTopSectionForMainScreen(
    ...
    val nextSong = musicControllerUiState.nextSong
    if(nextSong != null && musicControllerUiState.playerState == PlayerState.PLAYING) {
        nextTrackInfo.value = "${nextSong.artist} - ${nextSong.title}"
    } else {
        nextTrackInfo.value = ""
    }
